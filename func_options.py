...
username = urllib.parse.quote_plus('Fernando')

password = urllib.parse.quote_plus('9gvrttU3@nXbE*3')

# conexao = pymongo.MongoClient("mongodb://localhost:27017/")
conexao = pymongo.MongoClient("mongodb+srv://%s:%s@clusterdeteste.6p1zuwt.mongodb.net/?retryWrites=true&w=majority" % (username, password))
